...
for (be, hp, f, max_be_duration) in trace_files:
    for run in range(num_runs):
        ...
        os.system(f"{ld_preload_cmd} python3 ../../benchmarking/launch_jobs.py --algo orion --config_file {file_path} --orion_max_be_duration {max_be_duration} --kernel_gpu rtx6000")
